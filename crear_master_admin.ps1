# ============================================================
#  Crea pages\MasterAdmin.tsx
#  Ejecutar desde: D:\MIS APP\IPHONESHOP-USA-main
# ============================================================

$path = Join-Path (Get-Location) "pages\MasterAdmin.tsx"
...
Write-Host ""
Write-Host "OK - pages\MasterAdmin.tsx creado correctamente" -ForegroundColor Green
Write-Host ""
Write-Host "Ahora ejecuta:" -ForegroundColor Yellow
Write-Host "  git add . ; git commit -m 'feat: MasterAdmin page' ; git push origin main" -ForegroundColor Cyan
Write-Host ""
